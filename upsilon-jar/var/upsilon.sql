...
) ENGINE=InnoDB AUTO_INCREMENT=544636 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=194028 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `service_check_results` (
  ...
  `output` longtext,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=254644 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2012-09-09 23:52:56
