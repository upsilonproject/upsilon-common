...
public class GlobalConstants { 
    ...
    public static final Duration DEF_TIMER_QUEUE_MAINTAINER_DELAY = Duration.standardSeconds(5);
    ...
    public static final Duration DEF_INC_SERVICE_UPDATE = MIN_SERVICE_SLEEP; 
